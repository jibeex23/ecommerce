...
class _CartState extends State<Cart> {
  ...
  onQuantityIncrease(seller_index, item_index) {
    if (_shopList[seller_index].cart_items[item_index].quantity <
      ...
      ToastComponent.showDialog(
          "Impossible de commander plus de${_shopList[seller_index].cart_items[item_index].upper_limit} article(s) de ce",
          context,
  ...
  onQuantityDecrease(seller_index, item_index) {
    if (_shopList[seller_index].cart_items[item_index].quantity >
      ...
      ToastComponent.showDialog(
          "Impossible de commander moins de ${_shopList[seller_index].cart_items[item_index].lower_limit} article(s) de ce",
          context,
          gravity: Toast.CENTER,
          duration: Toast.LENGTH_LONG);
    }
  ...
  process({mode}) async {
    ...
    if (cart_ids.length == 0) {
      ToastComponent.showDialog("Le panier est vide", context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
    }
